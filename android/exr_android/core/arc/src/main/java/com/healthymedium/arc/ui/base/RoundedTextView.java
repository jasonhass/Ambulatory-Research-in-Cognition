...
public class RoundedTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        final TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.RoundedTextView, defStyle, 0);

        int fillColor = typedArray.getColor(R.styleable.RoundedTextView_fillColor,0);
        int strokeColor = typedArray.getColor(R.styleable.RoundedTextView_strokeColor,0);
        float dashLength = typedArray.getDimension(R.styleable.RoundedTextView_dashLength,0);
        float dashSpacing = typedArray.getDimension(R.styleable.RoundedTextView_dashSpacing,0);
        int strokeWidth = (int) typedArray.getDimension(R.styleable.RoundedTextView_strokeWidth,0);

        int radius = (int) typedArray.getDimension(R.styleable.RoundedTextView_radius,0);
        int radiusTopLeft = (int) typedArray.getDimension(R.styleable.RoundedTextView_radiusTopLeft,0);
        int radiusTopRight = (int) typedArray.getDimension(R.styleable.RoundedTextView_radiusTopRight,0);
        int radiusBottomLeft = (int) typedArray.getDimension(R.styleable.RoundedTextView_radiusBottomLeft,0);
        int radiusBottomRight = (int) typedArray.getDimension(R.styleable.RoundedTextView_radiusBottomRight,0);


        int gradientEnum = (int) typedArray.getInt(R.styleable.RoundedTextView_gradient,-1);
        int gradientColor0 = (int) typedArray.getColor(R.styleable.RoundedTextView_gradientColor0,0);
        int gradientColor1 = (int) typedArray.getColor(R.styleable.RoundedTextView_gradientColor1,0);
