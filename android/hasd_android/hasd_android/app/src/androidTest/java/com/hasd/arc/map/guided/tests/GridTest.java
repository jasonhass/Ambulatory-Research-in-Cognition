...
public class GridTest extends GuidedTestTemplate {

    @Override
    public void setup() {
        super.setup();

        TestBehavior.classes.stateMachine = GuidedStateMachine_GridTest.class;
        setupDefaultParticipant();
    }

    public static class GuidedStateMachine_GridTest extends StateMachine {
