...
public class SymbolTest extends AutomatedTestTemplate {
    ...
    public void setup() {
        ...
        TestBehavior.STEPS = 4;
        TestBehavior.classes.stateMachine = AutomatedStateMachine_SymbolTest.class;
    }

    public static class AutomatedStateMachine_SymbolTest extends StateMachine {
        boolean pass = true;
