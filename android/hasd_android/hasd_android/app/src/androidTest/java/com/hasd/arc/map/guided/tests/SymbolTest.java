...
public class SymbolTest extends GuidedTestTemplate {

    @Override
    public void setup() {
        super.setup();

        TestBehavior.classes.stateMachine = GuidedStateMachine_SymbolTest.class;
        setupDefaultParticipant();
    }

    public static class GuidedStateMachine_SymbolTest extends StateMachine {
