...
public class WakeSurvey extends GuidedTestTemplate {

    @Override
    public void setup() {
        super.setup();

        TestBehavior.classes.stateMachine = GuidedStateMachine_WakeSurvey.class;
        setupDefaultParticipant();
    }

    public static class GuidedStateMachine_WakeSurvey extends StateMachine {
