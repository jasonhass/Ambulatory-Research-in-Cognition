...
public class ContextSurvey extends GuidedTestTemplate {

    @Override
    public void setup() {
        super.setup();

        TestBehavior.classes.stateMachine = GuidedStateMachine_ContextSurvey.class;
        setupDefaultParticipant();
    }

    public static class GuidedStateMachine_ContextSurvey extends StateMachine {
