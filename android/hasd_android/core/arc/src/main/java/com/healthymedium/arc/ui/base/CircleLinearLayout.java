...
public class CircleLinearLayout extends LinearLayout {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        final TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.CircleLinearLayout, defStyle, 0);

        int fillColor = typedArray.getColor(R.styleable.CircleLinearLayout_fillColor,0);
        int strokeColor = typedArray.getColor(R.styleable.CircleLinearLayout_strokeColor,0);
        float dashLength = typedArray.getDimension(R.styleable.CircleLinearLayout_dashLength,0);
        float dashSpacing = typedArray.getDimension(R.styleable.CircleLinearLayout_dashSpacing,0);
        int strokeWidth = (int) typedArray.getDimension(R.styleable.CircleLinearLayout_strokeWidth,0);
        
        int gradientEnum = (int) typedArray.getInt(R.styleable.CircleLinearLayout_gradient,-1);
        int gradientColor0 = (int) typedArray.getColor(R.styleable.CircleLinearLayout_gradientColor0,0);
        int gradientColor1 = (int) typedArray.getColor(R.styleable.CircleLinearLayout_gradientColor1,0);
