...
//open class ResourcesView : UIView {
...
//        self.resourceItems = [
//            //("resources_availability", "cut-ups/icons/alarm-clock-solid-teal", {Arc.shared.appNavigation.navigate(state: EXState.rescheduleAvailability, direction: .toRight)}),
//            ("resources_contact", "cut-ups/icons/avatar-solid-teal", ACContactViewController.self),
//            ("resources_about_link", "cut-ups/icons/app-solid-teal", AboutViewController.self),
